...
function handleGetInvoices(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'getInvoices',
      data: null,
      message: 'Error retrieving invoices: ' + error.toString()
    };
  }
}
...
function handleFinalizeInvoice(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'finalizeInvoice',
      data: null,
      message: 'Error finalizing invoice: ' + error.toString()
    };
  }
}
...
function handleMarkInvoicePaid(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'markInvoicePaid',
      data: null,
      message: 'Error marking invoice as paid: ' + error.toString()
    };
  }
}
...
function handleDeleteInvoice(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'deleteInvoice',
      data: null,
      message: 'Error deleting invoice: ' + error.toString()
    };
  }
}
