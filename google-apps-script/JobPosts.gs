...
function handleGetJobPosts(payload, sessionUser) {
  try {
    ...
    return {
      ...
      action: 'getJobPosts',
      data: null,
      message: 'Error retrieving job posts: ' + error.toString()
    };
  }
}
...
function handleAddJobPost(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'addJobPost',
      data: null,
      message: 'Error adding job post: ' + error.toString()
    };
  }
}
...
function handleUpdateJobPost(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'updateJobPost',
      data: null,
      message: 'Error updating job post: ' + error.toString()
    };
  }
}
...
function handleDeleteJobPost(payload, sessionUser) {
  ...
  try {
    ...
    return {
      ...
      action: 'deleteJobPost',
      data: null,
      message: 'Error deleting job post: ' + error.toString()
    };
  }
}
